# ProConnect - Microservicio de Usuarios

Este microservicio se encarga de gestionar la lógica de negocio, registro y mantenimiento de la información de los usuarios dentro de la plataforma ProConnect.
...
2. Compila el proyecto y descarga las dependencias:
   ...
   ```
3. Ejecuta el microservicio (por defecto en el puerto 8081):
   ```bash
